...
5. map 例题
   ...
   1. 寻找最长不含有重复字符的子串
      - [https://leetcode.com/problems/longest-substring-without-repeating-characters/](https://gitee.com/link?target=https%3A%2F%2Fleetcode.com%2Fproblems%2Flongest-substring-without-repeating-characters%2F)
      - abcabcbb → abc
      - bbbbb → b
      - pwwkew → wke
   2. 解题思路：
